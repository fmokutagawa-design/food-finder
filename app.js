...
$("#searchButton").onclick=()=>search(true);$("#sort").onchange=sortAndRender;["dateTime","area","budget","openOnly","reservable","chefOnly","delivery"].forEach(id=>$("#"+id).onchange=()=>search());
